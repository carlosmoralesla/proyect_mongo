...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { money_type: @bank.money_type, name: @bank.name, number_account: @bank.number_account }
    end
  ...
  test "should update bank" do
    patch :update, id: @bank, bank: { money_type: @bank.money_type, name: @bank.name, number_account: @bank.number_account }
    assert_redirected_to bank_path(assigns(:bank))
  end
